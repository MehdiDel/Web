...
<h2 class = "center black-text "> Gestion des réservations "EN ATTENTE"</h2>
<div class="container">
  <div class="row">
    <div class="col s12">
      <ul class="tabs">
...
<?php include("Admin_jour_list.php"); ?>

<?php include("Admin_voyage_list.php"); ?>

<?php include("Admin_event_list.php"); ?>
